...
public class MybatisPlusGenerator {
    ...
    private static String DATABASE_URL = "jdbc:mysql://localhost:3306/integratedmanagerdb?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false&serverTimezone=GMT%2B8";
...
//        mpg.setTemplateEngine(new FreemarkerTemplateEngine());
    ...
    public static StrategyConfig getStrategyConfig() {
        ...
        strategy.setTablePrefix(new String[] { "tsec"});// 此处可以修改为您的表前缀
        // 需要包含的表名，允许正则表达式（与exclude二选一配置）
        strategy.setInclude("TSecComputerOnlineDateLog");
